            ...
            <div class="card-body p-0">
                <!-- Nested Row within Card Body -->
                    ...
                    <div class="col-lg-5 d-none d-lg-block bg-register-image"></div>
                        ...
                        <form class="user" method="POST" action="{{url('/edit-car/'.$car->id)}}" >
                                @csrf
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0 ">
                                       ...
                                       <option  {{ old('mark_id') == $car_mark->id || $car->model->mark_id == $car_mark->id ? "selected" : "" }} value="{{$car_mark->id}}">{{$car_mark->mark}}</option>
                                           @endforeach
                                       </select>
                                        ...
                                        <div class="col-sm-6"  >
                                            <select id="model_id" name="model_id" class="form-control" >
                                             @foreach ($car_models as $key => $car_model)
                                                <option  {{ old("model_id") == $car_model['id'] || $car_model['id'] == $car->model_id ? "selected" : "" }}  value="{{$car_model['id']}}">{{$car_model['model']}}</option>
                                             @endforeach
                                            </select>
                                ...
                                <div class="form-group row">
                                    <div class="col">
                                       <input type="text" class="form-control form-control-user {{ $errors->has('registration_number') ? ' is-invalid' : '' }}" value="{{ $car->registration_number ? $car->registration_number : old('registration_number') }}" id="registration_number" name="registration_number" placeholder="{{ trans('translate.registration_number')}}" required autofocus>
                                        ...
                                        <div class="col"  >
                                             <input type="number" class="form-control form-control-user {{ $errors->has('number_places') ? ' is-invalid' : '' }}" value="{{$car->number_places ? $car->number_places : old('number_places') }}" id="number_places" name="number_places" placeholder="{{ trans('translate.number_places')}}" required autofocus>
                                        ...
                                        <div class="col"  >
                                             <input type="number" class="form-control form-control-user {{ $errors->has('number_cylinder') ? ' is-invalid' : '' }}" value="{{$car->number_cylinder ? $car->number_cylinder : old('number_cylinder') }}" id="number_cylinder" name="number_cylinder" placeholder="{{ trans('translate.number_cylinder')}}" required autofocus>
                                        ...
                                        <div class="col"  >
                                             <input type="text" class="form-control form-control-user {{ $errors->has('color') ? ' is-invalid' : '' }}" value="{{$car->color ? $car->color : old('color') }}" id="color" name="color" placeholder="{{ trans('translate.color')}}" required >
                                        ...
                                        @endif
                                         ...
                                         <div class="col"  >
                                             <select id="type_car" name="type_car" class="form-control " >
                                                ...
                                                <option value="diesel"   {{ old('type_car') == 'diesel'     || $car->type_car == 'diesel' ? "selected" : "" }}>{{ trans('translate.diesel')}}</option>
                                                <option value="gasoline" {{ old('type_car') == 'gasoline' || $car->type_car == 'gasoline' ? "selected" : "" }}>{{ trans('translate.gasoline')}}</option>
                                                <option value="electric" {{ old('type_car') == 'electric' || $car->type_car == 'electric' ? "selected" : "" }}>{{ trans('translate.electric')}}</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                         <div class="col">
                                            <input id="datepicker" width="276" class="{{ $errors->has('purchaseDate') ? ' is-invalid' : '' }}" value="{{$car->purchaseDate ? $car->purchaseDate :  old('purchaseDate') }}"  name="purchaseDate" placeholder="{{ trans('translate.purchaseDate')}}" required  />
                                            ...
                                            <div class="col">
                                                ...
                                                <input class="form-check-input" type="checkbox" value="1" id="available" {{$car->available ?'checked' :'' }} name="available">
                                ...
                                <div class="form-group">
                                       <textarea id="description" name="description" class="form-control  {{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="Description" style="height:200px">{{ $car->description ? $car->description :old('description') }}</textarea>
